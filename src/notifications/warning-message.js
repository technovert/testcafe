export default {
    ...
    screenshotsFullPageNotSupported:         'ReadyTest does not support full-page screenshots in {browserAlias}.',
    ...
    browserManipulationsOnRemoteBrowser:     'The screenshot and window resize functionalities are not supported in a remote browser. They can function only if the browser is running on the same machine and in the same environment as the ReadyTest server.',
    ...
    videoBrowserResizing:                    'The browser window was resized during the "{testName}" test while ReadyTest recorded a video. ReadyTest cannot adjust the video resolution during recording. As a result, the video content may appear broken. Do not resize the browser window when ReadyTest records a video.',
